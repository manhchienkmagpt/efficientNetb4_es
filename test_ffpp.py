...
def parse_args():
    parser = argparse.ArgumentParser(description="Test a configurable backbone on FF++")
    parser.add_argument("--config", type=str, default="configs/config.yaml", help="Path to config YAML")
    parser.add_argument("--checkpoint", type=str, default="checkpoints/best_model.pth", help="Checkpoint path")
    parser.add_argument("--output-csv", type=str, default="ffpp_test_predictions.csv", help="CSV output path")
